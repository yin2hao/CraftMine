...
//    private MCGrid grid;//存方块数据
//    public McMap(int lx, int ly, int lz) {
//        LX = lx;
//        LY = ly;
//        LZ = lz;
//    }//转换
...
//        grid = new MCGrid(LX, LY, LZ);//初始化网络
...
//    }
//    // 生成洞穴  同上
//    boolean[][][] cave = cave(LX, LY, LZ, minh, maxh, Gaoduzhi / 7);
//        for (int a = 0; a < LX; a++) {
//        for(int b = 0; b < LY; b++) {
//            for(int c = 0; c < LZ; c++) {
//                if(cave[a][b][c]) {
//                    G.set(a, b, c, null); // 移除方块形成洞穴
//                }
//            }
//        }
//    }
